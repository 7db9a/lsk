...
fn list() {
        ...
        // Changing directories.
        path_cache.switch();
        let _ls_key = ls_key::LsKey::new(path, list_all, false, None, None);
...
fn fuzzy_list() {
        ...
        let ls_key = ls_key::LsKey::new(path, list_all, false, None, None);
...
fn list_go_up_one_level() {
        ...
        let mut ls_key = ls_key::LsKey::new(path, list_all, false, None, None);
